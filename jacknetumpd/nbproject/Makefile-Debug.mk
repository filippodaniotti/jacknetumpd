...
${OBJECTDIR}/_ext/65a73d24/SystemSleep.o: ../../BEBSDK/SystemSleep.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__TARGET_LINUX__ -I../../BEBSDK -I../../NetUMP -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/65a73d24/SystemSleep.o ../../BEBSDK/SystemSleep.cpp

${OBJECTDIR}/_ext/65a73d24/network.o: ../../BEBSDK/network.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/65a73d24
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__TARGET_LINUX__ -I../../BEBSDK -I../../NetUMP -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/65a73d24/network.o ../../BEBSDK/network.cpp

${OBJECTDIR}/_ext/8c65c7bb/NetUMP.o: ../../NetUMP/NetUMP.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c65c7bb
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__TARGET_LINUX__ -I../../BEBSDK -I../../NetUMP -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c65c7bb/NetUMP.o ../../NetUMP/NetUMP.cpp

${OBJECTDIR}/_ext/8c65c7bb/NetUMP_SessionProtocol.o: ../../NetUMP/NetUMP_SessionProtocol.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c65c7bb
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__TARGET_LINUX__ -I../../BEBSDK -I../../NetUMP -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c65c7bb/NetUMP_SessionProtocol.o ../../NetUMP/NetUMP_SessionProtocol.cpp
...
${OBJECTDIR}/_ext/5c0/Endpoint.o: ../Endpoint.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__TARGET_LINUX__ -I../../BEBSDK -I../../NetUMP -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Endpoint.o ../Endpoint.cpp

${OBJECTDIR}/_ext/5c0/UMP_mDNS.o: ../UMP_mDNS.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__TARGET_LINUX__ -I../../BEBSDK -I../../NetUMP -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/UMP_mDNS.o ../UMP_mDNS.cpp

${OBJECTDIR}/_ext/5c0/jacknetumpd.o: ../jacknetumpd.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__TARGET_LINUX__ -I../../BEBSDK -I../../NetUMP -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/jacknetumpd.o ../jacknetumpd.cpp
